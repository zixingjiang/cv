...
\begin{tablist}
	...
	\textit{Research Intern, SUN Lab (surgical robots and medical devices)} \hfill \textit{Feb. 2023 -- Aug. 2023}\\
...
\begin{tablist}
	...
	\item[2024--] \tab Robotic Ultrasound-Guided Prostate Biopsy \hfill CUHK
	...
	\item[2023--24] \tab Autonomous Robotic Lung Ultrasound \hfill CUHK
	...
	\item[2020--23] \tab Manipulator-Assisted UAV Landing System for USV \hfill CUHK-Shenzhen
...
\begin{itemize}
	\item \texttt{ndi\_ros2\_driver} (\href{https://github.com/zixingjiang/ndi_ros2_driver}{https://github.com/zixingjiang/ndi\_ros2\_driver}): \texttt{ros2\_control} integration for Northern Digital Inc. (NDI) electromagnetic tracking and optical navigation systems.
	
	\item \texttt{minimal\_handeye\_ros2} (\href{https://github.com/zixingjiang/minimal_handeye_ros2}{https://github.com/zixingjiang/minimal\_handeye\_ros2}): Minimal hand-eye calibration node for ROS 2.
\end{itemize}
...
\section*{Awards}
\begin{tablist}
	\item[2024] \tab Bronze Award, The 14th ``Challenge Cup'' Chinese College Students Entrepreneurship Competition
...
\begin{tablist}
	...
	\item[Software] \tab Robotics development: ROS, MoveIt, Gazebo, CoppeliaSim, SOFA\\
	Libraries: Eigen, NumPy, OpenCV, Open3D, PyTorch, scikit-learn\\
	Modeling: SolidWorks, Blender\\
	Miscellaneous: Docker, 3D Slicer, \LaTeX
